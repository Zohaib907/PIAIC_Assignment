...
function displayedMagicians(magicians: string[]){
...
function makingGreat(magicians: string[]){
...
var magicians: string[] = ["David Copperfield", "Harry Houdini", "Penn Jillette", "Teller"];
  
// Call make_great() to modify the magician names
var great :string []  = makingGreat(magicians);
// Call original array
